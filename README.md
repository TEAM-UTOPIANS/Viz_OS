...
Enter process data in JSON format:
[
...
Click Simulate to generate random allocation matrices
View the safe sequence and RAG visualization
Deadlock Detection
Set the number of processes and resources
Click Detect Deadlock to analyze the system
View deadlock status and wait-for graph
📊 API Endpoints
CPU Scheduling
...
Start simulating OS algorithms!
